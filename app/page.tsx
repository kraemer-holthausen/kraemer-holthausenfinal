    ...
    <main>
      ...
      <section id="offering" className="py-20 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-6">
          {[
            { t: "Website-Bots", d: "Start-Chips, geführte Flows, DSGVO-Opt-ins. Design in eurer CI." },
            { t: "Termin & CRM", d: "Kalenderbuchung, E-Mail und Webhooks. Handover ans Team." },
            { t: "Prozess-Automation", d: "Vom Lead-Scoring bis zum FAQ-Support. EU-Hosting, Logging minimiert." },
          ].map((c) => (
      ...
      <section id="kontakt" className="py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-white/70 mt-3">Kurzer Call, klare Roadmap. Wir setzen eine Demo auf eurer Domain auf.</p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:info@kraemer-holthausen.de" className="pill bg-white text-black border-white">E-Mail schreiben</a>
            <a href="tel:+490000000000" className="pill">Jetzt anrufen</a>
          </div>
        </div>
      </section>
    </main>
